...
void Scenes::LoadCarTest(GameManager* gm)
{
	...
	gm->carBody->setPosition(elevate::Vector3(0.0f, 20.5f + 1.10f + 0.05f, 0.0f));
	...
	gm->car->chassisMesh = new Cube(elevate::Vector3(0.0f, 20.5f + 1.10f + 0.05f, 0.0f), halfSize * 2, &gm->ammoShader, gm);
